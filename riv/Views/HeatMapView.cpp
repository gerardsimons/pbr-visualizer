...
//		heatmap.clear();
//		
//		RIVTable<float,ushort> *pathTable = (*dataset)->GetTable("path");
//		
//		//Find x and y record
//		RIVFloatRecord* xRecord = pathTable->GetRecord<float>("x");
//		RIVFloatRecord* yRecord = pathTable->GetRecord<float>("y");
//		RIVShortRecord* intersections = pathTable->GetRecord<ushort>("#intersections");
//		
//		xMax = xRecord->Max() + 1;
//		yMax = yRecord->Max() + 1;
//		
