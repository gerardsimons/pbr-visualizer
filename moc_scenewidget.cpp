...
static const char qt_meta_stringdata_SceneWidget[] = {
    "SceneWidget\0"
};
...
const QMetaObjectExtraData SceneWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SceneWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_SceneWidget,
      qt_meta_data_SceneWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SceneWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SceneWidget))
        return static_cast<void*>(const_cast< SceneWidget*>(this));
    if (!strcmp(_clname, "RIV3DView"))
        return static_cast< RIV3DView*>(const_cast< SceneWidget*>(this));
